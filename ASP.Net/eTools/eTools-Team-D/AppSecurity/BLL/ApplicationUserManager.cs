...
namespace AppSecurity.BLL
{
    ...
    {
        #region Constants
        internal const string STR_DEFAULT_PASSWORD = "Password1";
        ...
        public EmployeeInfo User_GetEmployee(string username)
        {
            ...
            if (employeeid == null)
            {
                throw new Exception("Not a registered user member, Please register or login as Employee account to continue!");
            }
            else
            {
