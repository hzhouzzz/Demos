...
namespace eToolsSystem.BLL
{
    ...
    public class ReceivingController
    {
        ...
        //public void For_CloseOrder(Unorder_Close purchaseorder, List<Unorder_Close> stoItem)
        //{

        //    using (var context = new eToolsContext())
        //    {
        //        PurchaseOrder newPurchaseOrder = new PurchaseOrder();
        //        newPurchaseOrder.PurchaseOrderID = purchaseorder.PurchaseOrderID;
        ...
        //        newPurchaseOrder.Closed = purchaseorder.Closed;

        //        ReceivingController sysmgr = new ReceivingController();
        //        int rowsUpdate = sysmgr.Update_PurchaseOrder(newPurchaseOrder);


        //        foreach (var item in stoItem)
        //        {
